...
class GestuReNN:
    ...
    def __init__(self, labelJsonPath='', plot=True, include_fingerup=False, batch_size=128, model_path=None):
        ...
        # model parameters
        self.lstm1_hid_dim = 256
        self.lstm2_hid_dim = 64
...
class GestuReNN_GRU:
    ...
    def define_model_with_state(self):
        ...
        # RNN Definition
        lstm1 = GRU(self.lstm1_hid_dim, input_shape=(None, self.tup), return_sequences=True,activation=LeakyReLU(alpha=0.1),
